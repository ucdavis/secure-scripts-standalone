...
?>
  ...
  <?php
	...
	while ($facstaff < 2) {
		$facstaff++;
		if ($facstaff == 1) $sql = "select * from people where listing like \"%=36=%\" and listing like \"%=1=%\" order by lname";
		else {
			$sql = "select * from people where listing like \"%=36=%\" and not (listing like \"%=1=%\") order by lname";
?>
