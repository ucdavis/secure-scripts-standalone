...
<title>Ketosis - Pathology Data</title>
</head>
		...
		if ($sub_data == "Submit Pathology Data")
		{
			...
			if ($valid_form == true)
			{
				...
				if (mysqli_affected_rows($link) >= 1)
				{
					...
					<a href= \"subject.php\">Go Back to Subject Sample Data Main Page</a><p>$q_update";
...
//			$q_pathology = "SELECT * FROM pathology WHERE an_id LIKE '74' AND genotype LIKE 'C57BL/6' ";
			...
			print "<form name= 'pathology' method= 'post' action= 'pathology.php'>";
