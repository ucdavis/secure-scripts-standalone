...
function DropDown ($list_table, $list_item, $list_dbid, $list, $db_link)
{
  $q_getlist = "select * from $list_table ORDER BY $list_item";
  $r_getlist = mysqli_query($db_link, $q_getlist);
  $list_total = 0;
  while ($row_getlist = mysqli_fetch_array($r_getlist, MYSQLI_ASSOC))
  {
