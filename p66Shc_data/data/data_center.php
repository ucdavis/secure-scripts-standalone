...
// SEND E-MAIL NOTIFICATION TO KYOUNGMI KIM AND ADDRESSES LISTED IN THE CC NOTIFICATION					
					...
					$subject = "p66Shc Data File Upload notifcation";
					$contents = "Hello, \n\n";
					$contents .= "A p66Shc data file for $file_type has been uploaded by $upload_by.  \n\n";
					
					
					$contents .= "Please visit our website at http://p66shc.phs.ucdavis.edu/data_login.php to view this file. \n\n";
...
// SEND E-MAIL NOTIFICATION TO ALL IF THE FILE TYPE IS MONTHLY MEETING
		...
		//					$ccemail = "margaret@cdoc-online.org";
							$subject = "p66Shc Monthly Meeting Notes Uploaded";

							$contents = "Hello $row_notify[fname], \n\n";
							$contents .= "p66Shc monthly meeting notes have been uploaded by $upload_by.  \n\n";
					
							$contents .= "Please visit http://p66shc.phs.ucdavis.edu/data_login.php to view this file. \n\n";
							$contents .= "Best regards, \n\n";
							$contents .= "p66Shc Program";
							$from = "noreply@ucdavis.edu";
							$header = "From: \"p66Shc Program\" <".$from.">\r\n"; 
