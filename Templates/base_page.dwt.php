...
require_once "../clinepi/config.inc.php";
?>  


<? include "../clinepi/includes/css_scripts.php"; ?>

<!-- TemplateBeginEditable name="page_title" -->
<title>Department of Public Health Sciences - UC Davis School of Medicine</title>
<!-- TemplateEndEditable -->
<? include "../clinepi/includes/meta_info.php"; ?> 
...
<? include "../clinepi/includes/top_header.php"; ?>
 
<!-- End Header Section -->
 
 
	<div id="titlebar">
    	<? include "../clinepi/includes/site_title.php"; ?>
    	<p></p>
    </div> <!-- titlebar -->
...
<!--        <div class="leftnavitem" id="leftcolsidebar0">	-->
     ...
     <!--        	<div id="menu_phsLeft"> -->
				    	<? include "../clinepi/includes/left_menu.php"; ?>	
<!--                 </div> menu_phsLeft -->           
...
<? include "../clinepi/includes/footer.php"; ?>
</div> <!-- footer -->
...
<? include "../clinepi/includes/analytics.php"; ?>
<!-- End Analytics Tags -->
...
<? //include "../clinepi/includes/home_images.js"; ?>
<!-- TemplateEndEditable -->
