...
$tcec_listing = "=23=";
$pid = "423";  // Robin Kipke personnel database ID
...
//{
	...
	if ($fp = fopen("/var/www/non_www/.my.cnf", "r"))
	{
		...
		{
			$sql2 = "select * from people where authid like \"$userID\" AND  listing like \"%$tcec_listing%\" ";
			//$sql2 = "select * from people where authid like \"$userID\" AND  id like \"%$pid%\" ";
