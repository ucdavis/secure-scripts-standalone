...
<!--<span class="contentHead">Faculty</span> -->
      <P>
        ...
        <?php
        	...
        	print "<p>";
        		print "<form name= \"add_instrument\" method=\"post\" action=\"tcec_instrument_detail.php\">";
...
<?php
	if ($dbok) {
		$q_instrument = "SELECT * FROM instrument_database WHERE delete_instrument <> \"1\" ORDER BY public_display DESC, tcec_tested, instrument_title";
...
//				print "<td><strong>Instrument Number</strong></td>";
	          print "<td><strong>Instrument Name</strong></td>";
            print "<td><strong>Instrument Description</strong></td>";
...
//			print "<tr><td>&nbsp;</td></tr>";
			...
			while ($row_instrument = mysqli_fetch_array($r_instrument, MYSQLI_ASSOC))
			{
				...
				$fileDocLink = "tcec_openDoc.php?file_id=$instrument_hash";
...
//				if (($delete_instrument == "1") && ($no_show == "0"))
//				{
//					$no_show = 1;
//					$instrument_ct = 1;
//					print "<tr><td>&nbsp;</td></tr>";
//					print "<tr><td colspan=\"4\"><h2>Deleted Instruments<h2></td></tr>";
...
//					print "<td valign=\"top\">$instrument_number</td>" ;
          print "<td valign=\"top\">$instrument_title</td>" ;
          print "<td valign=\"top\">$instrument_disp_name</td>" ;
//					print "<td valign=\"top\">$type_string</td>" ;
					...
					print "<td valign=\"top\">";
						print "<form name= \"instrument_view\" method=\"post\" action=\"tcec_instrument_detail.php\">";
